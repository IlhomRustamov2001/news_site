...
from .views import user_login, dashboard_view, register, SignUp, edit_user, EditUserView
...
urlpatterns=[
    ...
    path('password-resete/complete/', PasswordResetCompleteView.as_view(), name='password_reset_complete'),
    path('signup/', register, name='user_register'),
